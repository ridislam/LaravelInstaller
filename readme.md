# Laravel Web Installer | A Web Installer [Package](https://packagist.org/packages/ridislam/laravel-installer)

[![Total Downloads](https://poser.pugx.org/ridislam/laravel-installer/d/total.svg)](https://packagist.org/packages/ridislam/laravel-installer)
[![Latest Stable Version](https://poser.pugx.org/ridislam/laravel-installer/v/stable.svg)](https://packagist.org/packages/ridislam/laravel-installer)
[![License](https://poser.pugx.org/ridislam/laravel-installer/license.svg)](https://packagist.org/packages/ridislam/laravel-installer)
...
```bash
    composer require ridislam/laravel-installer
```
...
```php
	'providers' => [
	    ridislam\LaravelInstaller\Providers\LaravelInstallerServiceProvider::class,
	];
```
...
* If you have any suggestions please let me know : https://github.com/ridislam/LaravelInstaller/pulls.
* Please help us provide more languages for this awesome package please send a pull request https://github.com/ridislam/LaravelInstaller/pulls.
