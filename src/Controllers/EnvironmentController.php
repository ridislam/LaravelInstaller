...
namespace RidIslam\LaravelInstaller\Controllers;

use Illuminate\Routing\Controller;
use App\User;
use Illuminate\Http\Request;
use Illuminate\Routing\Redirector;
use RidIslam\LaravelInstaller\Helpers\EnvironmentManager;
use RidIslam\LaravelInstaller\Helpers\DatabaseManager;
use RidIslam\LaravelInstaller\Events\EnvironmentSaved;
use Validator;
use Session;
...
class EnvironmentController extends Controller
{
    ...
    private $api_url = 'http://api.inilabs.net';
    /**
    ...
    /**
     * TODO: We can remove this code if PR will be merged: https://github.com/RidIslam/LaravelInstaller/pull/162
